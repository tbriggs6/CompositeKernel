 ...
 */
public class HillClimberAccuracyRBF {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 3)
        {
            System.err.println("Error: run as java hillClimbing/HillClimberAccuracyRBF command DIR/valid-train.txt nRestarts");
            return;
        }
        HillClimberAccuracyRBF HC = new HillClimberAccuracyRBF(args[0],args[1]);
        TestResult result = HC.climbHills( Integer.parseInt(args[2]));
    }
    
    public HillClimberAccuracyRBF( String command , String fileName )
    {
