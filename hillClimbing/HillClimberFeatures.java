 ...
 */
public class HillClimberFeatures {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 4)
        {
            System.err.println("Error: run as java hillClimbing/HillClimberFeatures command DIR/valid-train.txt nRestarts nfields");
            return;
        }
        HillClimberFeatures HC = new HillClimberFeatures(args[0],args[1], args[3]);
        TestResult result = HC.climbHills( Integer.parseInt(args[2]));
    }
    
    public HillClimberFeatures( String command , String fileName, String strNumFields )
    {
        E = new AccuracyEvaluator(command);
        this.fileName = fileName;
        this.numFields = Integer.parseInt(strNumFields);
    }
    ...
    public KernelParams randomStart( )
    {
        ...
        FeatureSelectorParams state = FeatureSelectorParams.randomStart(numFields);
