 ...
 */
public class HillClimberAccuracyPoly {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 3)
        {
            System.err.println("Error: run as java hillClimbing/HillClimberAccuracyPoly command DIR/valid-train.txt nRestarts");
            return;
        }
        HillClimberAccuracyPoly HC = new HillClimberAccuracyPoly(args[0],args[1]);
        TestResult result = HC.climbHills( Integer.parseInt(args[2]));
    }
    
    public HillClimberAccuracyPoly( String command , String fileName )
    {
    ...
    public TestResult climbHills(int maxIterations )
    {
        ...
        for (int i = 0; i < maxIterations; i++)
        {
            ...
            if (i > 0) {
                System.out.println("   ITER: The best kernel so far: " + bestState);
                System.out.println("\n");
                System.out.println("   ITER: The best accuracy so far: " + bestResult.getAccuracy());
                System.out.println("\n");
            }
        ...
        System.out.println("The best accuracy: " +bestResult);
        System.out.println("-------------------------");
        System.out.println("\n\n\n");
    ...
    public TestResult climbHillsIteration( )
    {
        ...
        do {
            ...
            System.out.println("expanding: " + lastState.toString());
	...
	SimpleKernelParams state = new SimpleKernelParams((int)(Math.random() * 20)+1,
